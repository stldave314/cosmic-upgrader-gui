...
hide-to-tray = Masquer dans la zone d'état
...
minimize-to-tray = Masquer dans la zone d'état au lieu de quitter
minimize-to-tray-description = Ajoute un bouton Masquer. Le bouton de fermeture de la fenêtre quitte toujours.
