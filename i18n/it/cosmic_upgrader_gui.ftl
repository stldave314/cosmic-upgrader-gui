...
hide-to-tray = Nascondi nell'area di stato
...
minimize-to-tray = Nascondi nell'area di stato invece di uscire
minimize-to-tray-description = Aggiunge un pulsante Nascondi. Il pulsante di chiusura della finestra esce comunque.
...
tray-hide = Nascondi la finestra
tray-quit = Esci
